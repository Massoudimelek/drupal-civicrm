...
if (!defined('CIVICRM_DSN')) {
  if (CIVICRM_UF === 'UnitTests' && isset($GLOBALS['_CV']['TEST_DB_DSN'])) {
    ...
    define('CIVICRM_DSN', 'mysql://root:root@localhost:3306/civicrm?new_link=true');
  }
}
...
$civicrm_root = '/var/www/drupalvm/drupal/web/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/drupalvm/drupal/web/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://d7civicrm.dev/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'e9dc48a5429e084c35c98b779d0e8c8c');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/drupalvm/drupal/web/sites/default/files/civicrm/templates_c//mail.log');
// }
